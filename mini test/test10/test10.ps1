...
Check-Result ($output.Contains("Total paths: 2")) "path limit stops enumeration at requested count"
Check-Result ($output.Contains("Path limit reached: yes")) "path-limit reason is explicit"
Check-Result ($output.Contains("status: partial")) "truncated enumeration uses partial status"
