...
| `src/analysis/FunctionAnalysis.cpp` | Boolean / Function Analysis | CaDiCaL SAT helper、equivalence、`canNetBeValue()`、always-0/always-1、`runFunctionQuery()` |
...
| `src/analysis/PathAnalysis.cpp` | Startpoint-to-endpoint Path Analysis | path endpoint resolver、exist/find/enumerate/min/max/every-through/every-avoid path query、DFF boundary path traversal、`runPathQuery()` |
...
| Function/SAT analysis | `src/analysis/FunctionAnalysis.cpp` | 已完成 |
